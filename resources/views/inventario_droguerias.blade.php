@extends('layouts.app')
@section('title', 'Catálogo de ' . $drogueria->nombre)
@section('content')
  <style>
    :root {
      --primary: #ff6b00;
  ...
  <div class="productos-container">
    @php
      $TIPO_DROGUERIA = config('establecimientos.TIPO_DROGUERIA');
    @endphp
      ...
      <div class="producto-card">
        ...
        <div class="producto-info">
          ...
          <form action="{{ route('cart.store') }}" method="POST" class="mt-4">
            ...
            <input type="hidden" name="establecimiento_id" value="{{ $drogueria->id }}">
            <input type="hidden" name="establecimiento_tipo" value="{{ $TIPO_DROGUERIA }}">
