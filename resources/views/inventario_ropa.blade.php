@extends('layouts.app')
@section('title', 'Catálogo de ' . $tienda->nombre)
@section('content')
  <style>
    :root {
      --primary: #ff6b00;
...
@endif
  ...
  <h1 class="section-title">Catálogo de {{ $tienda->nombre }}</h1>
  ...
  <div class="productos-container">
    @php
      $TIPO_ROPA = config('establecimientos.TIPO_ROPA');
    @endphp
      ...
      <div class="producto-card">
        ...
        <div class="producto-info">
          ...
          <form action="{{ route('cart.store') }}" method="POST" class="mt-4">
            ...
            <input type="hidden" name="establecimiento_id" value="{{ $tienda->id }}">
            <input type="hidden" name="establecimiento_tipo" value="{{ $TIPO_ROPA }}">
